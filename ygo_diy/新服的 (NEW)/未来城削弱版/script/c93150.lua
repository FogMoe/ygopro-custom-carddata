...
function c93150.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	and Duel.IsExistingTarget(c93150.tofilter,tp,LOCATION_MZONE,0,2,nil)
	end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,c93150.tofilter,tp,LOCATION_MZONE,0,2,2,nil)
...
function c93150.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c93150.spfilter,tp,LOCATION_PZONE,0,2,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c93150.spfilter,tp,LOCATION_PZONE,0,2,2,nil,e,tp)
...
function c93150.atkval(e,c)
	return Duel.GetMatchingGroupCount(c93150.afilter,c:GetControler(),LOCATION_EXTRA,0,nil)*300
end
