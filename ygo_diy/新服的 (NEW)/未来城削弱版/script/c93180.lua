...
-------
	...
	e4:SetCountLimit(1,93181+EFFECT_COUNT_CODE_DUEL)
...
function c93180.ftarget(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsPlayerCanDraw(tp,1)
		and Duel.IsExistingTarget(c93180.ffilter,tp,LOCATION_EXTRA,0,5,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectTarget(tp,c93180.ffilter,tp,LOCATION_EXTRA,0,5,99,nil)
