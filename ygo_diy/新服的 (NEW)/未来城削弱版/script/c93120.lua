...
function c93120.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c93120.cxfilter,tp,LOCATION_EXTRA,0,4,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c93120.cxfilter,tp,LOCATION_EXTRA,0,4,4,nil)
